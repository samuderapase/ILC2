        ...
        if($GKMenu && ($GKMenu.height || $GKMenu.width)) {     
            base.getElements('li.haschild').each(function(el){     
                if(el.getElement('.childcontent')) {
                    ...
                    var fxStart = { 'height' : $GKMenu.height && content.getParent().getParent().hasClass('level0') ? 0 : prevh, 'width' : $GKMenu.width && !content.getParent().getParent().hasClass('level0') ? 0 : prevw, 'opacity' : 0 };
